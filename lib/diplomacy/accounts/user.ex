defmodule Diplomacy.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Diplomacy.Repo)
  ...
  """
  def valid_password?(%Diplomacy.Accounts.User{hashed_password: hashed_password}, password)
